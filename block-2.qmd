...
3. Copy the PDF into your `git-exercise` folder
...
## Practical: git scavenger hunt (setup) {background-color="black"}
...
4. Run the following command `git clone https://github.com/open-teaching/git-scavenger-hunt.git`

## Practical: git scavenger hunt (part 1/2) {background-color="black"}

Answer the following questions using `git`.
...
## Practical: git scavenger hunt (part 2/2) {background-color="black"}
