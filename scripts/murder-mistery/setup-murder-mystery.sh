...
git add .
GIT_COMMITTER_DATE="1973-04-26T00:00:00" git commit --date="1973-04-26" -m "Wealthy Businessman Found Murdered in Colchester Mansion (1973)"

cp ../1976-11-12/news.md ./news.md
cp ../1976-11-12/image.jpg ./image.jpg
git add .

GIT_COMMITTER_DATE="1976-11-12T00:00:00" git commit --date="1976-11-12" -m "Shocking Murder of Young Woman Rocks Colchester Community (1976)"

cp ../1977-08-06/news.md ./news.md
cp ../1977-08-06/image.jpg ./image.jpg
git add .
GIT_COMMITTER_DATE="1977-08-06T00:00:00" git commit --date="1977-08-06" -m "Violent Crime Wave Continues in Colchester as Another Citizen Falls Victim (1977)"
