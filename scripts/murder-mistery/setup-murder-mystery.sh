...
cp ../1970-04-26/news.md ./news.md
cp ../1970-04-26/image.jpg ./image.jpg
git add .
git commit --date="1970-04-26" -m "Wealthy Businessman Found Murdered in Colchester Mansion (1970)"
