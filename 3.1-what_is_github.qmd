...
3. In the terminal, navigate up one folder (`cd ..`)
4. Clone the repository to check whether you can authenticate with github
5. Go back to the `git-exercise` folder (`cd git-exercise`)
