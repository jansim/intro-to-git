...
- We will first use git via its CLI (i.e. in the Terminal).
  - In Visual Studio Code, open the bottom panel
    - Button in top-left corner or [Cmd/Ctrl] + J
  - On Windows, select "Git Bash" in little dropdown
...
git config --global user.email "your.email@yourmail.edu"
```
